    ...
    <div class="container" id="slider">
        <div id="carousel-example-generic" class="carousel slide " data-ride="carousel">
            ...
            <div class="carousel-inner" role="listbox">
                ...
                $ordNo = 0;
                ?>
                @foreach($horzPics as $horzPic)
                    <div class="item{{$ordNo == 0?' active':''}}" data-item="{{$horzPic['id']}}">
                        <a href="#"><img
                                    src="statics/images/upload/{{$horzPic['filename']}}"
            ...
            <ol class="carousel-indicators hidden-xs">
                ...
                ?>
                @foreach($horzPics as $horzPic)
                    <li data-target="#carousel-example-generic" data-slide-to="{{$horzPic['id']}}"
                    {{$ordNo == 0?'class=active':''}}></li>
                    <?php
                    $ordNo += 1;
                    ?>
                @endforeach
                        ...
                        <div class='single-tab text-muted'>
                            ...
                            <div class="text-center">
                                <a href="{{URL::route("site.article", $article['id'])}}">
                                    <img src="/statics/images/upload/{{$article->file()}}"
                                         class='content-img'></a>
                            </div>
